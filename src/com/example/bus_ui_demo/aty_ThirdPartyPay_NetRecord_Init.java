...
public class aty_ThirdPartyPay_NetRecord_Init extends Activity
{
	private ImageButton ib_check;
	private LinearLayout Lin_whyClick;
	private myApplication myApp;
	private TextView tv_title;
	private static final int THIRDPARTY_PAY_NETRECORD = Global_Config.THIRDPARTY_PAY_NETRECORD;
	...
	{
		tv_title.setText(getString(R.string.ThirdPartyPayRecord_Nettitle));
		...
		Lin_whyClick.setOnClickListener(new OnClickListener()
		{
			...
			{
				// TODO Auto-generated method stub
				AlertDialog.Builder builder = new AlertDialog.Builder(aty_ThirdPartyPay_NetRecord_Init.this);
		...
		ib_check.setOnClickListener(new OnClickListener()
		{
			...
			{
				// TODO Auto-generated method stub
				Intent intent = new Intent(aty_ThirdPartyPay_NetRecord_Init.this, aty_ThirdPartyPay_NetRecord.class);
				//startActivity(intent);
				myApp.setCircleStep(THIRDPARTY_PAY_NETRECORD);
